...
def test_swap_best_by_category():
    ...
    assert item_f not in jesse.inventory and item_f in tai.inventory
    assert item_c not in tai.inventory and item_c in jesse.inventory
...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert len(jesse.inventory) == 3
    assert len(tai.inventory) == 3
    assert item_d not in tai.inventory and item_e not in tai.inventory and item_f not in tai.inventory
    assert item_a not in jesse.inventory and item_b not in jesse.inventory and item_c not in jesse.inventory
    # *********************************************************************
    # ****** Complete Assert Portion of this test **********
    # *********************************************************************
    # Assertions should check:
